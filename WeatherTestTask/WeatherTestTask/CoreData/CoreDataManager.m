...
//    _contextQueue = dispatch_get_current_queue();
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WeatherTestTask" withExtension:@"momd"];
...
- (void)handleContextDidSaveNotification:(NSNotification*)notification {
    ...
    if (_managedObjectContext == nil || _managedObjectContext == incomingContext) return;
