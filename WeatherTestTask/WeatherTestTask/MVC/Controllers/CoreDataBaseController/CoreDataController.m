...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SomeCustomCell" forIndexPath:indexPath];
...
#pragma mark - Fetched results controller (It has to take place in any controller that inherits from self)
